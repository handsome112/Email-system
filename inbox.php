...
<html>	
	...
	<body>
		...
		<div class="container-fluid">
		  ...
		  <img src="images.jpg" style="position:absolute; top:15px; left:440px; height:80px; width:80px;">
		  <img src="logo.jpg" style="position:absolute; top:2px; left:540px; height:105px; width:400px;">  
...
<?php
$ins="select * from emsg where rid='".$uid."' order by sn desc";
