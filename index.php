	...
	<body>
		<nav class="navbar navbar-inverse" style="background:transparent; border: none;">
		  <div class="container-fluid" style="height:90px;">
		    ...
		    <img src="images.jpg" style="position:absolute; top:20px; left:40px; height:60px; width:60px;">
		    <img src="logo.jpg" style="position:absolute; top:5px; left:120px; height:80px; width:400px;">
